...
export default function EditRecipe() {
  const { recipes, editRecipe, addNotification } = useRecipes();
  ...
  const handleSubmit = (e) => {
    ...
    editRecipe(parseInt(id), updatedRecipe);
    addNotification("Рецепт обновлен успешно!", "success");
    navigate("/recipes");
  };
    ...
    <div style={container}>
      ...
      <form onSubmit={handleSubmit} style={formStyle}>
        ...
        <div style={buttonGroup}>
          <button type="submit" style={submitButton}>Сохранить изменения</button>
